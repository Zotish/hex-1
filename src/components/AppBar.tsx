    ...
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
         ...
         <a href="https://hexskull.net">
         <div className='flex text-white items-center'>
           <svg width="105%" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
               <image href="/image.png" x="0" y="0" width="100" height="100" /> 
            </svg>
            <p className='text-white'>HexSkull </p>
           </div>
         </a>
              ...
              <svg width="105%" height="24" viewBox="0 0 646 96" fill="none" xmlns="/candy-machine-ui/public/image.png">
               ...
               <a href="" target="_blank" rel="noopener noreferrer"  className="text-secondary hover:text-white">
            </a>
          </div>
